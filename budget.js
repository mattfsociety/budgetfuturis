...
return {
	...
	//maand en jaar laten zien
	displayMonth: function(){
		//alle variabelen bovenin zodat ik het woord var niet meer nodig heb.
		var now, months, month, year;

		now = new Date();
		
		//alle maanden in een array, januari is 0 enzovoorts....
		...
		document.querySelector(ALLEstrings.dateLabel).textContent = months[month] + ' ' + year;
